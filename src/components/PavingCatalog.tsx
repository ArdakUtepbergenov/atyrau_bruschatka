...
const PavingCatalog = () => {
  ...
  { id: 3, name: "Паркет мрамор", price: 7800, category: "classic", size: "Толщина 4 см", image: img27 },
  ...
  { id: 8, name: "Бархат", price: 5000, category: "classic", size: "Толщина 4,5 см", image: img4 },
  ...
  { id: 24, name: "Прокурор жёлтый", price: 5000, category: "classic", size: "Толщина 4 см", image: img21 },
  ...
  { id: 15, name: "Мрамор Каменный цветок", price: 7800, category: "classic", size: "Толщина 4 см", image: img11 },
  { id: 18, name: "Миллион", price: 4500, category: "classic", size: "Толщина 4 см", image: img15 },
  { id: 19, name: "Ромашка", price: 5500, category: "classic", size: "Толщина 4,5 см", image: img16 },
  { id: 20, name: "Вавилон", price: 4500, category: "classic", size: "Толщина 4 см", image: img17 },
  { id: 16, name: "Мрамор Вавилон", price: 7800, category: "classic", size: "Толщина 4 см", image: img20 },
  { id: 25, name: "Поребрик серый", price: 900, category: "classic", size: "", unit: "50 см", image: img22 },
  { id: 26, name: "Поребрик цветной", price: 1500, category: "classic", size: "", unit: "50 см", image: img23 },
  ...
  { id: 23, name: "Хайтек", price: 3800, category: "concrete", size: "Толщина 3 см", image: img12 },
  { id: 17, name: "Атырау", price: 6800, category: "geometric", size: "Толщина 5 см", image: img13 },
  { id: 21, name: "Астана жёлтый", price: 5000, category: "classic", size: "Толщина 4 см", image: img18 },
