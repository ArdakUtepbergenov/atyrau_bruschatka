...
const PavingCatalog = () => {
  ...
  { id: 15, name: "Мрамор Каменный цветок", price: 6800, category: "classic", size: "Толщина 4 см", image: img11 },
  ...
  { id: 23, name: "Хайтек", price: 3500, category: "concrete", size: "Толщина 3 см", image: img12 },
